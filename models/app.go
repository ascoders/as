...
type App struct {
	Base        `bson:"-" json:"-"`
	Id          string        `bson:"_id" json:"id"`        // 主键 也是讨论组英文路径
	Manager     bson.ObjectId `bson:"m" json:"manager"`     // 管理员
	Helper      []string      `bson:"hl" json:"helper"`     // 助手（协助版主只能操作帖子，不能进管理台） !!!!!!! ms
...
func (this *App) New() interface{} {
	var r *User
	return &r
}

func (this *App) NewSlice() interface{} {
	var r []*User
	return &r
}
